...
car *car_ptr=new car(); // при создании объекта вызовится конструктор
...
cout<<car_ptr->get_mark()<<" "<<car_ptr->get_power()<<" л.с. "<<car_ptr->get_cost()<<"р"<<endl; // выводим данные объекта c помощью методов

delete car_ptr; // освобождаем память выделенную для объекта класса car
system("pause"); // команда задержки  экрана
}
